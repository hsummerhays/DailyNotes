...
namespace DailyNotes.Api.Controllers
{
    ...
    [Authorize]
    public class TopicNotesController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<TopicNote>>> GetAll(
            ...
            [FromQuery] int? tagId)
        {
            var query = _context.TopicNotes.AsQueryable();
        ...
        {
            var note = await _context.TopicNotes.FindAsync(id);
            if (note == null)
                return NotFound();
        ...
        public async Task<IActionResult> Update(int id, TopicNote topicNote)
        {
            ...
            var existing = await _context.TopicNotes.FindAsync(id);
            if (existing == null)
                return NotFound();
