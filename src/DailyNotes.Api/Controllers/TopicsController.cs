...
namespace DailyNotes.Api.Controllers
{
    ...
    public class TopicsController : ApiControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Topic>>> GetAll(
            ...
            => Ok(await _service.GetAllAsync(parentId, all, ct: HttpContext.RequestAborted));
        ...
        {
            var topic = await _service.GetByIdAsync(id, ct: HttpContext.RequestAborted);
        ...
        {
            var children = await _service.GetChildrenAsync(id, ct: HttpContext.RequestAborted);
        ...
        {
            var notes = await _service.GetNotesForTopicAsync(id, ct: HttpContext.RequestAborted);
