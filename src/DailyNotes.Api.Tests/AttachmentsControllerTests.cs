...
{
    public class AttachmentsControllerTests : IClassFixture<CustomWebApplicationFactory>
    {
        ...
        [Fact]
        public async Task Post_CreatesAttachmentSuccessfully()
        {
