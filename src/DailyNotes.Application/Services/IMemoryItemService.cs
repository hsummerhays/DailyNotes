...
namespace DailyNotes.Application.Services
{
    public interface IMemoryItemService
    {
        ...
        Task<IEnumerable<MemoryItem>> SearchAsync(float[] queryEmbedding, double minImportanceScore = 0.0, string? memoryType = null, string? memoryStatus = "Active", int limit = 5);
    }
}
